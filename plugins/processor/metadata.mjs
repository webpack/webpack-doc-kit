...
import { SOURCE_METADATA } from './router.mjs';
...
const allReflections = project => Object.values(project.reflections);

const publicName = reflection => reflection.getFullName?.();
...
export const applySourceMetadata = (
  ...
  for (const reflection of allReflections(project)) {
    if (
      !reflection.kindOf(
