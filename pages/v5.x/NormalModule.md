...
* Type: {GeneratorOptions} Optional.
...
* Type: {ParserClass} Optional.

***

#### `parserOptions`

* Type: {ParserOptions} Optional.
...
* Type: {ResourceSchemeData & Partial<ResolveRequest>} Optional.
...
* `noParseRule` {string|RegExp|Function|string|RegExp|Function[]}
* `request` {string}
